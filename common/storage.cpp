...
#include "storage.h"
#include "general.h"
#define hworld_ROCKSDB_MAX_OPEN_FILES 5000
	...
	bool Storage::Initialize(const DbConfigure &db_config, bool bdropdb) {
		...
		do {
			...
			else
			{
				...
				keyvaule_max_open_files = (keyvaule_max_open_files > hworld_ROCKSDB_MAX_OPEN_FILES) ? -1 : keyvaule_max_open_files;
				ledger_max_open_files = (ledger_max_open_files > hworld_ROCKSDB_MAX_OPEN_FILES) ? -1 : ledger_max_open_files;
				account_max_open_files = (account_max_open_files > hworld_ROCKSDB_MAX_OPEN_FILES) ? -1 : account_max_open_files;
			}
