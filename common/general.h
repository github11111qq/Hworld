...
namespace hworld {
	...
	public:
		...
		const static char *hworld_VERSION;
	...
	class SlowTimer : public utils::Singleton<hworld::SlowTimer>, public utils::Runnable {
	public:
		SlowTimer();
		~SlowTimer();
	...
	class Global : public utils::Singleton<hworld::Global>, public TimerNotify {
		asio::io_service io_service_;
